...
struct CheckersLobbyView: View {
    @State private var viewModel = CheckersLobbyViewModel()
    ...
    @ViewBuilder
    private func lobbyRow(_ game: CheckersGameRow) -> some View {
        ...
        NavigationLink {
            CheckersMultiplayerView(initialGame: game)
        } label: {
            HStack {
